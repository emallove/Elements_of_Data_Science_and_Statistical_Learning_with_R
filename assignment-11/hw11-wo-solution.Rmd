...
getTestData <- function(nObsArg = 1000, nClassVarsArg = 2, nNoiseVarsArg = 1, deltaClassArg = 1) {
  nObs <- nObsArg
...
ggplot_Lda_Rf_Knn <- function(err, dfTmp, ldaTmpTbl, rfTmpTbl) {
...
# works fine here
# ggplot_Lda_Rf_Knn(err, dfTmp, ldaTmpTbl, rfTmpTbl)
```
...
compare_LDA_KNN_RandomForest <- function(nObsArg, nClassVarsArg, nNoiseVarsArg, deltaClassArg) {
  ...
  l <- getTestData(nObsArg, nClassVarsArg, nNoiseVarsArg, deltaClassArg)
  xyzTest    <- l$xyzTest
  xyzTrain   <- l$xyzTrain
  classTest  <- l$classTest
  classTrain <- l$classTrain
  ...
  print(ggplot_Lda_Rf_Knn(err, dfTmp, ldaTmpTbl, rfTmpTbl))
}
