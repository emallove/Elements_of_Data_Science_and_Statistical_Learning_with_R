...
points(x = rep(c(1,2,3,4,5,6,7), 3), y = wifi_loc_data_matrix1[,-8], pch = 1)
...
>
> Select all rows with "1" in the 8 column
> matrix(m[m[,8] == 1], ncols=8)
>


```{r wifiPlot,fig.height=5,fig.width=10}
oldPar <- par(mfrow=c(1:2),ps=16)
...
```{r wifiPlotGG,fig.height=3,fig.width=6}
