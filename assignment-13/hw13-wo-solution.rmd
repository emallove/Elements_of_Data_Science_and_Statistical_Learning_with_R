...
redIndicies <- (
  unique(
    (1:length(x))[x > myBound],
    (1:length(x))[y > myBound],
    (1:length(x))[z > myBound],
    (1:length(x))[x < -myBound],
    (1:length(x))[y < -myBound],
    (1:length(x))[z < -myBound]
  )
...
scatterplot3d(cbind(x, y, z, 
  col = ifelse((x > myBound | y > myBound | z > myBound | x < -myBound | y < -myBound | z < -myBound ), 'red','black')))
